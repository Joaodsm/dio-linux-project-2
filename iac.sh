...
useradd carlos -m -c "Pedro do setor Administrativo" -s /bin/bash -G GRP_ADM -p $(openssl passwd -crypt 1234)
passwd carlos -e
useradd maria -m -c "José do setor Administrativo" -s /bin/bash -G GRP_ADM -p $(openssl passwd -crypt 1234)
passwd maria -e
useradd joao -m -c "João do setor Administrativo" -s /bin/bash -G GRP_ADM -p $(openssl passwd -crypt 1234)
passwd joao -e

echo "Setor de vendas..."
useradd debora -m -c "Carlos do setor de Vendas" -s /bin/bash -G GRP_VENDAS -p $(openssl passwd -crypt 1234)
passwd debora -e
useradd sebastiana -m -c "Joana do setor de Vendas" -s /bin/bash -G GRP_VENDAS -p $(openssl passwd -crypt 1234)
passwd sebastiana -e
useradd roberto -m -c "Roberta do setor de Vendas" -s /bin/bash -G GRP_VENDAS -p $(openssl passwd -crypt 1234)
passwd roberto -e
